...
def figure_S3b():
    ...
    marker_violins(
        ...
        filename="figS3b_nonneuronal-marker-violins", figdir="figure_S03"
    )
...
def figure_S3d():
    ...
    genes_umi_violins(
        ...
        figdir="figure_S03", filename="figS3d_nonneuronal-umi-genes-violins"
    )
...
def figure_S4a():
    ...
    sc.pl.umap(
        ...
        color="cluster_final", show=False, ax=ax, title="",
...
def figure_S4b():
    ...
    for genes in gene_list:
        ...
        scatter_1by2(
            nonneuronal_final, genes, 
            selection=nonneuronal_final.obs.cluster_final.isin(list("123456")), label_ha="right",
            filename=f"figS4b_oligo-lineage_{gene_label}", figdir="figure_S04", add_marker_edges=False
        )
...
def figure_S4c():
    ...
    fig, ax = plt.subplots(1, 1, figsize=(4, 4))
    sc.pl.umap(
        nonneuronal_final[nonneuronal_final.obs.cluster_final.isin(["7", "8", "9", "10", "11"])],
        color="cluster_final", show=False, ax=ax, title="",
        palette=nonneuronal_palette,
    )
    ax.legend(bbox_to_anchor=(1.0, 0.5), loc="center left", ncol=1, frameon=False)
...
def figure_S4d():
    ...
    for genes in gene_list:
        ...
        scatter_1by2(
            nonneuronal_final, genes, 
            selection=nonneuronal_final.obs.cluster_final.isin(["7", "8", "9", "10", "11"]), label_ha="right",
            filename=f"figS4d_astro-lineage_{gene_label}", figdir="figure_S04", add_marker_edges=False
        )
...
def figure_S5a():
    ...
    scatter_2by2(
        ...
        filename="figS5a_arcuate-umap-markers", figdir="figure_S05", add_marker_edges=False
    )
...
def figure_S5b():
    ...
    marker_violins(
        ...
        filename="figS5b_arcuate-marker-violins", figdir="figure_S05"
    )
...
def figure_S6a():
    ...
    scatter_2by2(
        supramammillary, genes, 
        filename="figS6a_cluster8_key-genes-1", figdir="figure_S06",
...
def figure_S6c():
    ...
    scatter_2by2(
        supramammillary, genes, 
        filename="figS6c_cluster8_key-genes-2", figdir="figure_S06",
        add_marker_edges=False, label_va="top", label_ha="left", markersize=16
    )
...
def figure_S7a():
    ...
    scatter_2by2(
        neuronal_final, genes, 
        filename="figS7a_premammillary-umap-markers", figdir="figure_S07", 
...
def figure_S7b():
    ...
    marker_violins(
        ...
        filename="figS7b_premammillary-marker-violins", figdir="figure_S07"
    )
